		...
		.ready(
				function() {
					...
					if(upblogcontent!=null&&upblogcontent!=''){
						upblogcontentHtml='<i class="fa fa-caret-up"></i> 上一篇：<a href="/rzblog/blogcontent/details/'+upblogcontent.showId+'"  title="'+upblogcontent.title+'">'+upblogcontent.title+'</a>';
					}
					
					var downblogcontentHtml='<i class="fa fa-caret-down"></i> 下一篇：<a href="/rzblog">返回首页</a>'
					if(downblogcontent!=null&&downblogcontent!=''){
						downblogcontentHtml='<i class="fa fa-caret-down"></i> 下一篇：<a href="/rzblog/blogcontent/details/'+downblogcontent.showId+'"  title="'+downblogcontent.title+'">'+downblogcontent.title+'</a>';
					}
					// 添加
					...
					if(drelatedblogcontentList!=null&&drelatedblogcontentList!=''&&drelatedblogcontentList.length>0){
						...
						for(var i=0;i<drelatedblogcontentList.length;i++){
							drelatedblogcontentListHtml=drelatedblogcontentListHtml+'<li><a href="/rzblog/blogcontent/details/'+drelatedblogcontentList[i].showId+'"  title="'+drelatedblogcontentList[i].title+'">'+drelatedblogcontentList[i].title+'</a></li>';
						}
